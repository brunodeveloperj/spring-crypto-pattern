...
/**
 * Exception resolver for {@link DecryptionException}.
 *
 * <p>Maps decryption failures to an
 ...
 */
@Component
public class DecryptionExceptionResolver implements ExceptionResolver<DecryptionException> {

  /**
   * Resolves a DecryptionException instance and returns an ErrorResponse object. This method maps the exception to an appropriate error response.
   *
   * @param error the DecryptionException instance to be resolved
   * @return an ErrorResponse object representing the error response
   */
  @Override
  public ErrorResponse resolve(DecryptionException error) {
