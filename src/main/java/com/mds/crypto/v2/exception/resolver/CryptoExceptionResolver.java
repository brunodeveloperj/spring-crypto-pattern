...
/**
 * Exception resolver for {@link CryptoException}.
 *
 * <p>Maps generic cryptographic failures to an
 ...
 */
@Component
public class CryptoExceptionResolver implements ExceptionResolver<CryptoException> {

  /**
   * Resolves a CryptoException instance and returns an ErrorResponse object. This method maps the exception to an appropriate error response.
   *
   * @param error the CryptoException instance to be resolved
   * @return an ErrorResponse object representing the error response
   */
  @Override
  public ErrorResponse resolve(CryptoException error) {
